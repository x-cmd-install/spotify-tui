...
![spotify-tui](https://repo.x-cmd.io/spotify-tui.svg?lang=zh)
...
合计: **10,925** 行代码（覆盖前 5 种语言、共 **52** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 10,828 | 259 | 958 | 45 |
| Yaml | 43 | 0 | 3 | 1 |
| Toml | 33 | 1 | 3 | 2 |
| Html | 21 | 0 | 0 | 1 |
| Markdown | 0 | 613 | 218 | 3 |
...
- **上游仓库**: <https://github.com/Rigellute/spotify-tui>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.25.0` (2021-08-24)
- **最近提交**: 2021-11-17
- **Release 含资产**: 6 个

## 流行度

- **Star**: 19,347 · **Fork**: 581 · **开放 issue**: 565 · **贡献者**: 90

## 累计统计

- **发布数**: 32 · **已合并 PR**: 418 · **开放 PR**: 35 · **已关闭 issue**: 294 · **开放 issue**: 271 · **提交数**: 1272
...
| last720d | 2024-09-21 | 0 | 0 | 2 | 6 | 16 | 0 |
...
在 [repology.org](https://repology.org/project/spotify-tui) 上共有 **5** 个发行版报告此项目。**5** 个 ✅ 已是最新上游版本，**0** 个 ⚠️ 使用旧版本。
...
spotify-tui 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `spotify-tui` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/spotify-tui.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T05:31:55Z._
